...
<html>
  ...
  <body>
      ...
      <div width="100%" style="margin-top:70px;">
        <h3 class="text-center" style="text-decoration: underline;"><strong>Reporte de Atraso</strong></h3>
      </div>
    </div>
    <div class="">
    ...
    <div class="">
      <p style="text-decoration: underline;"><strong>Sanción</strong></p>
      ...
      <table width="50%" class="table">
          <tr style="margin-bottom:10px;">
            ...
            <td id="v_pend">{{ $reporte[0]->v_saldo + 0.5 }} Días</td>
          </tr>
          <tr style="margin-bottom:10px;">
            <th>Día Descontado</th>
            <td id="v_sol">0.5 Día</td>
          </tr>
          <tr style="margin-bottom:10px;">
